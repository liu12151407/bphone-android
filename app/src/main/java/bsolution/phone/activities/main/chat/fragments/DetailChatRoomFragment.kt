 ...
 */
package bsolution.phone.activities.main.chat.fragments
...
import bsolution.phone.activities.main.chat.ChatScrollListener
import bsolution.phone.activities.main.chat.adapters.ChatMessagesListAdapter
import bsolution.phone.activities.main.chat.data.ChatMessageData
import bsolution.phone.activities.main.chat.data.EventLogData
import bsolution.phone.activities.main.chat.viewmodels.*
import bsolution.phone.activities.main.chat.views.RichEditTextSendListener
import bsolution.phone.activities.main.fragments.MasterFragment
...
import bsolution.phone.activities.navigateToDevices
import bsolution.phone.activities.navigateToImageFileViewer
import bsolution.phone.activities.navigateToImdn
import bsolution.phone.compatibility.Compatibility
import bsolution.phone.databinding.ChatRoomDetailFragmentBinding
import bsolution.phone.databinding.ChatRoomMenuBindingImpl
import bsolution.phone.utils.*
import java.io.File
...
class DetailChatRoomFragment : MasterFragment<ChatRoomDetailFragmentBinding, ChatMessagesListAdapter>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.doOnPreDraw {
            ...
            sharedViewModel.chatRoomFragmentOpenedEvent.value = bsolution.phone.utils.Event(true)
        }
        ...
        adapter.forwardMessageEvent.observe(
            ...
            it.consume { chatMessage ->
                ...
                sharedViewModel.messageToForwardEvent.value =
                    bsolution.phone.utils.Event(chatMessage)
                sharedViewModel.isPendingMessageForward.value = true

                if (sharedViewModel.isSlidingPaneSlideable.value == true) {
                    Log.i("[Chat Room] Forwarding message, going to chat rooms list")
                    sharedViewModel.closeSlidingPaneEvent.value = bsolution.phone.utils.Event(true)
                } else {
        ...
        adapter.addSipUriToContactEvent.observe(
            ...
            it.consume { sipUri ->
                ...
                sharedViewModel.updateContactsAnimationsBasedOnDestination.value =
                    bsolution.phone.utils.Event(R.id.masterChatRoomsFragment)
